...
namespace Eng.Agilium.Be.Migrations
{
  ...
  public partial class Initial_DB_Structure : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateIndex(name: "IX_Items_AssigneeId", table: "Items", column: "AssigneeId");

      migrationBuilder.CreateIndex(name: "IX_Items_ParentId", table: "Items", column: "ParentId");

      migrationBuilder.CreateIndex(name: "IX_Items_ProjectId", table: "Items", column: "ProjectId");

      migrationBuilder.CreateIndex(name: "IX_Memberships_ProjectId", table: "Memberships", column: "ProjectId");

      migrationBuilder.CreateIndex(name: "IX_Memberships_UserId", table: "Memberships", column: "UserId");

      migrationBuilder.CreateIndex(name: "IX_Projects_Title", table: "Projects", column: "Title", unique: true);

      migrationBuilder.CreateIndex(name: "IX_Roles_ProjectId", table: "Roles", column: "ProjectId");

      migrationBuilder.CreateIndex(name: "IX_SprintItems_ItemId", table: "SprintItems", column: "ItemId");

      migrationBuilder.CreateIndex(name: "IX_SprintItems_SprintId", table: "SprintItems", column: "SprintId");
      ...
      migrationBuilder.CreateIndex(name: "IX_Templates_ProjectId", table: "Templates", column: "ProjectId");

      migrationBuilder.CreateIndex(name: "IX_Tokens_AppUserId", table: "Tokens", column: "AppUserId");

      migrationBuilder.CreateIndex(name: "IX_WorkflowStates_ProjectId", table: "WorkflowStates", column: "ProjectId");
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.DropTable(name: "SprintItems");

      migrationBuilder.DropTable(name: "TemplateItems");
      ...
      migrationBuilder.DropTable(name: "WorkflowStates");

      migrationBuilder.DropTable(name: "TemplateColumns");
